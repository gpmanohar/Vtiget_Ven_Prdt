...
public class Scenario_4With_DDT {
	...
	public static void main(String[] args) throws Throwable {
		...
		String Orgname = book.getSheet("organization").getRow(4).getCell(2).getStringCellValue();
...
//		logout of Application
		...
		System.out.println("LOGOUT OF APPLICATION SUCCESFULLY");
		driver.close();
